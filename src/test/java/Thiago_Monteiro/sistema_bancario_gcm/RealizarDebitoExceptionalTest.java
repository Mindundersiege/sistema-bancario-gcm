...
public class RealizarDebitoExceptionalTest {

	@Parameters()
	public static Collection<Object[]> buildData() {
		return Arrays.asList(new Object[][] { //
				{ 0, 1500.0, DebitoException.class, "Valor maior do que saldo disponivel." }, //
						{ 8, 100.0, ListaDeContasException.class, "Conta nao encontrada." }, //
						{ 1, -1.0, DebitoException.class, "Valor negativo." }, //
				});
	}
	...
	public void testParseInvalidRank() {
		...
		Command realizarDeb = new RealizarDebitoCommand(sis, id, valor);
		realizarDeb.execute();
	}
